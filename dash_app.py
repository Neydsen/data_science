...
def get_pie_chart(entered_site):
    if entered_site == "ALL":
        ...
        fig = px.pie(filtered_df,
                     names="class",
                     title="Success and Failed Count for site {}".format(entered_site))
...
def get_scatter_chart(entered_site, payload_range):
    if entered_site == "ALL":
        ...
        fig = px.scatter(filtered_df,
                         ...
                         y="class",
                         color="Booster Version Category",
                         title="Correlation between Payloead and Success for site {}".format(entered_site))
...
Which payload range(s) has the highest launch success rate? [1,952-3,696.65], [4,600-5,300]
Which payload range(s) has the lowest launch success rate? [500-6,761]
